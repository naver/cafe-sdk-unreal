    ...
    , StopRecordMethod(GetClassMethod("stopRecord", "()V"))
{
    ...
    jclass localGlinkClass = FAndroidApplication::FindJavaClass("com.naver.glink.android.sdk.Glink");
    ...
    StatisticsClass = FAndroidApplication::FindJavaClass("com.naver.glink.android.sdk.Statistics");
